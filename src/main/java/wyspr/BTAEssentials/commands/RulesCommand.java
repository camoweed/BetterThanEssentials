...
@SuppressWarnings("ALL") public class RulesCommand implements CommandManager.CommandRegistry {
	@Override
	public void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register((ArgumentBuilderLiteral) (ArgumentBuilderLiteral
			...
			.executes(context -> {
				...
				for (String line : BTAEssentials.rules.get(1)) player.sendMessage(line);
			...
			.executes(context -> {
				...
				for (String line : BTAEssentials.rules.get(page)) player.sendMessage(line);
