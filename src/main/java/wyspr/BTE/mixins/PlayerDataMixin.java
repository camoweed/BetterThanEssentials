...
import wyspr.BTE.utils.IPlayerData;
import wyspr.BTE.utils.PlayerData;

@Environment(EnvType.SERVER) @Mixin(value = PlayerServer.class, remap = false) public class PlayerDataMixin implements IPlayerData {
	@Unique
